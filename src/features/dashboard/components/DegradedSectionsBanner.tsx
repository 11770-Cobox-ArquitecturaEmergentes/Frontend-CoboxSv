...
export function DegradedSectionsBanner({ sections }: DegradedSectionsBannerProps) {
    ...
    <Card className="border-amber-200 bg-amber-50 p-4">
      <div className="flex gap-3">
        ...
        <div className="min-w-0">
          <h2 className="text-sm font-semibold text-amber-950">Informacion parcial del dashboard</h2>
